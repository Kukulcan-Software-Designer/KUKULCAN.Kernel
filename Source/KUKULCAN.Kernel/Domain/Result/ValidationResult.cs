...
public sealed class ValidationResult
{
    ...
    /// </summary>
    public KUKULCAN.Kernel.Domain.Result.Result ToResult() => IsValid
        ? KUKULCAN.Kernel.Domain.Result.Result.Ok()
        : KUKULCAN.Kernel.Domain.Result.Result.Fail(Error.Validation(
            "Validation.Failed",
