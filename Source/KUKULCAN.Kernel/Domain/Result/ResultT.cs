...
public sealed class Result<T>
{
    ...
    public KUKULCAN.Kernel.Domain.Result.Result ToResult() => IsSuccess ? KUKULCAN.Kernel.Domain.Result.Result.Ok() : KUKULCAN.Kernel.Domain.Result.Result.Fail(Error);
